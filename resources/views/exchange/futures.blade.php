...
<div class="td-input-group" id="buy-price-group">
                        ...
                        <button class="td-action-btn buy-btn" id="buy-btn-label" onclick="submitFuturesOrder('buy')">Long BTC</button>
                    </div>
...
<div class="td-input-group" id="sell-price-group">
                        ...
                        <button class="td-action-btn sell-btn" id="sell-btn-label" onclick="submitFuturesOrder('sell')">Short BTC</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    // Submit Order
    function submitFuturesOrder(side) {
        let price = parseFloat($(`#${side}-price`).val()) || currentPrice;
        let amount = parseFloat($(`#${side}-amount`).val()) || 0;
