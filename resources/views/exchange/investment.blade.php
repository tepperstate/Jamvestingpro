...
<div class="container-fluid py-4">
    ...
    <div class="row mb-5" data-aos="fade-up">
        <div class="col-xl-9">
            <h1 class="h2 outfit font-weight-bold text-white mb-2">Crypto ETFs</h1>
            <p class="text-secondary small">Invest in top-performing Crypto ETFs. Set it and forget it.</p>
        </div>
    ...
    <div class="row mb-5" data-aos="fade-up">
        <div class="col-12">
            <h2 class="outfit font-weight-bold text-white mb-4">My ETF Portfolio</h2>
                                    ...
                                    <td class="py-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="rounded-circle bg-white d-flex align-items-center justify-content-center overflow-hidden" style="width: 32px; height: 32px; padding: 2px;">
                                                <img src="{{ $active->package->logo ?? \App\Services\AssetLogoService::getFallbackUrl('ETF') }}" style="width: 100%; height: 100%; object-fit: cover;">
                                            </div>
                                            <div>
        ...
        <div class="col-12">
            <div class="bento-card p-4 d-flex flex-wrap gap-5 align-items-center">
                ...
                <div class="flex-grow-1 text-end">
                    <p class="text-secondary small mb-0 mt-2">All ETF positions are locked until maturity. Early withdrawal penalties apply.</p>
                </div>
            </div>
        </div>
    </div>
