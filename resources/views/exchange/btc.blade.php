    ...
    <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-8 col-md-10">
            <div class="glass-card-premium p-4 p-md-5 text-center">
                ...
                <h3 class="outfit font-weight-bold mb-4 text-white">Transfer <span class="text-danger">BTC</span></h3>
                ...
                <div class="mb-4">
                    <p class="text-secondary small mb-2">Send precisely <strong class="text-white">{{ number_format($amount, 5) }} BTC</strong> to the designated BTC gateway address:</p>
                ...
                <div class="p-3 mb-4 rounded-3" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.04);">
                    <p class="text-secondary mb-0 small" style="line-height: 1.5;">
                        <i class="ri-error-warning-line text-warning me-1"></i> Ensure you transfer assets only via the supported Bitcoin network. Sending any other cryptographic asset may lead to irreversible loss.
                    </p>
                </div>
