...
@section('title', 'Futures Trading History')
        ...
        <div class="col-12">
            <div class="glass-card p-4" style="background: rgba(16, 18, 27, 0.4); backdrop-filter: blur(16px); border-radius: 24px; border: 1px solid rgba(255,255,255,0.05);">
                <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-dark">
                    <h5 class="outfit font-weight-bold mb-0 text-white d-none d-md-block">Futures History</h5>
                    <ul class="nav nav-pills gap-2" id="history-tabs" style="border-color: rgba(255,255,255,0.05) !important; margin: 0;">
                        <li class="nav-item">
                            <a class="nav-link px-3 py-1 bg-primary text-white font-weight-bold" href="{{ route('futures.history') }}" style="border-radius: 8px; font-size: 0.75rem; letter-spacing: 0.5px;">HISTORY</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3 py-1 text-secondary" href="{{ route('futures.trade') }}" style="border-radius: 8px; font-size: 0.75rem; letter-spacing: 0.5px; background: rgba(255,255,255,0.05);">TRADE</a>
                        </li>
                    </ul>
                        ...
                        <tbody id="ledger-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-4">
                                        <div>
                                            <div class="text-white fw-bold outfit">{{ $t->futuresPair->symbol ?? 'N/A' }}</div>
                                ...
                                <td class="fw-bold outfit text-white">
                                    ${{ number_format($t->margin_amount, 2) }}
                                </td>
                                <td class="fw-bold outfit text-white">
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <div class="text-secondary">Your futures history is currently empty.</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                ...
                <div class="mobile-cards-view d-md-none flex-column gap-3">
                    ...
                    <div class="glass-card p-3 ledger-mobile-card" style="background: rgba(16, 18, 27, 0.4); border: 1px solid rgba(255,255,255,0.05); border-radius: 16px;">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom border-secondary border-opacity-25">
                            <div class="d-flex align-items-center gap-2">
                                <div>
                                    <div class="text-white fw-bold outfit ledger-search-target">{{ $t->futuresPair->symbol ?? 'N/A' }}</div>
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-6">
                                ...
                                <div class="text-white fw-bold">${{ number_format($t->margin_amount, 2) }}</div>
                            </div>
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="text-secondary small">Your futures history is empty.</div>
                    </div>
                    @endforelse
                </div>
