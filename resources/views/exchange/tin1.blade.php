            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document"> 
                <div class="modal-content">
                    ...
                    <div class="modal-header" style="display:flex;justify-content:center;align-items:center;padding:20px; background: #f8f9fa;">
                        <h2 style="font-weight: 800; color: #1a202c; letter-spacing: -1px;">Account Compliance</h2>
                    </div>
                    <div class="modal-body">
                        <div class="row animate__animated animate__fadeIn " style="padding-top: 10px; padding-bottom: 10px">
                            ...
                            @if(session('status'))
                                ...
                                <p>To proceed with your transaction, please provide a valid Regulatory Tax Verification (TIN) for your jurisdiction.</p>
                                <p>You can secure your compliance clearance by settling the required regulatory fee of ${{number_format($tax->amount,2)}} below.</p>
                                ...
                                <br>
                                <br>
                                <p>Please send only USDT To the following address below</p>
                               ...
                               @if(isset($proof))
                                  @if($proof->status_one == '0')
                                    <a disabled  class="btn btn-block btn-sm btn-primary text-light">Proceeed</a>
                                  @else
                                    <a href="{{route('tin2')}}" class="btn btn-block btn-sm btn-primary">Proceeed</a>
                                  @endif
                               @else
                                    <a disabled  class="btn btn-block btn-sm btn-primary text-light">Proceeed</a>
                               @endif
