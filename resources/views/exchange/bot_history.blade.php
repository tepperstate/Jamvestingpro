        ...
        <div class="col-12">
            <div class="glass-card p-4" style="background: rgba(16, 18, 27, 0.4); backdrop-filter: blur(16px); border-radius: 24px; border: 1px solid rgba(255,255,255,0.05);">
                <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-dark">
                    <h5 class="outfit font-weight-bold mb-0 text-white d-none d-md-block">Bot History & Performance</h5>
                    ...
                    <div class="d-flex gap-3 align-items-center">
                        ...
                        <div class="badge bg-primary-soft text-primary px-3 py-2" style="border-radius: 8px;">
                            <i class="ri-robot-2-line me-1"></i> {{ auth()->user()->is_demo ? 'DEMO ENVIRONMENT' : 'REAL ENVIRONMENT' }}
                        </div>
                    </div>
                </div>
                        ...
                        <tbody id="ledger-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-4">
                                        ...
                                        <div>
                                            <div class="text-white fw-bold outfit">{{ $botName }}</div>
                                            <div class="text-secondary" style="font-size: 10px;">{{ $botSymbol !== 'BOT' ? $botSymbol : 'Market' }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-primary-soft text-primary px-3 py-2" style="border-radius: 6px;">
                                        AUTO EXECUTED
                                    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="badge bg-secondary-soft text-secondary px-2 py-1">Bot</span>
                                </td>
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <div class="text-secondary">Your bot history is currently empty. Start a bot to populate your history.</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                ...
                <div class="mobile-cards-view d-md-none flex-column gap-3">
                    ...
                    <div class="glass-card p-3 ledger-mobile-card" style="background: rgba(16, 18, 27, 0.4); border: 1px solid rgba(255,255,255,0.05); border-radius: 16px;">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom border-secondary border-opacity-25">
                            <div class="d-flex align-items-center gap-2">
                                <x-asset-logo :symbol="$botSymbol" size="sm" />
                                <div>
                                    <div class="text-white fw-bold outfit ledger-search-target">{{ $botName }}</div>
                                    <div class="text-secondary" style="font-size: 10px;">{{ \Carbon\Carbon::parse($t->created_at)->format('d M, Y H:i') }}</div>
                                </div>
                            </div>
                            <span class="badge bg-primary-soft text-primary px-2 py-1" style="border-radius: 4px; font-size: 0.7rem;">
                                AUTO EXECUTED
                            </span>
                        </div>
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="text-secondary small">Your bot history is empty.</div>
                    </div>
                    @endforelse
                </div>
