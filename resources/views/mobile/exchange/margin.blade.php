                ...
                <table class="table text-white mb-0 align-middle" style="font-size:0.75rem; border-collapse: separate; border-spacing: 0 4px;">
                    ...
                    <tbody>
                        ...
                        <tr class="spot-order-row" data-id="{{ $o->id }}" data-symbol="{{ $o->symbol }}" data-type="{{ $o->type }}" data-price="{{ $o->price }}" data-amount="{{ $o->amount }}" data-ordertype="{{ $o->order_type }}" data-trigger="{{ $o->trigger_price }}" data-status="{{ $o->status }}" style="background: rgba(255,255,255,0.01); border-radius: 4px;">
                            <td class="py-2 border-0" data-label="ASSET Symbol">
                                <div class="d-flex align-items-center gap-2">
                            ...
                            <td class="py-2 border-0" data-label="Type">
                            ...
                            <td class="py-2 border-0 font-weight-bold" data-label="Amount">{{ number_format($o->amount, 6) }}</td>
                            <td class="py-2 border-0 text-secondary" data-label="Entry/Trigger Price">${{ number_format($o->price, 2) }}</td>
                            <td class="py-2 border-0 text-white font-weight-bold" data-label="Reserves (USD)">${{ number_format($o->total_usd, 2) }}</td>
                            <td class="py-2 border-0 text-secondary" id="sim-price-{{ $o->id }}" data-label="Current Price">--</td>
                            <td class="py-2 border-0 text-end font-weight-bold" id="sim-pl-{{ $o->id }}" data-label="Unrealized P/L">--</td>
                            <td class="py-2 border-0 text-end" data-label="Ledger Status">
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="text-center py-4 text-secondary">No trades processed inside active ledger.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
