                ...
                <div class="table-responsive">
                    <table class="table table-dark-glass table-borderless mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-white-50" data-label="Position ID">{{ $pos->trade_id }}</td>
                                <td data-label="Asset">
                                ...
                                <td class="text-white" data-label="Collateral">${{ number_format($pos->collateral, 2) }}</td>
                                <td class="text-white" style="font-family: monospace;" data-label="Entry Price">${{ number_format($pos->entry_price, 2) }}</td>
                                <td class="text-white-50" data-label="Size">{{ number_format($pos->quantity, 4) }}</td>
                                ...
                                <td class="text-white-50 small" data-label="Date">{{ $pos->created_at->format('Y-m-d H:i') }}</td>
                            </tr>
                            @empty
                            <tr>
