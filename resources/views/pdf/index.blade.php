...
@endphp
    ...
    <div class="info">
        <span><strong>Account Name:</strong> {{ $data['name'] }}</span>
        <span><strong>Account Type:</strong> {{ $data['type'] }}</span>
        <span><strong>Account Balance:</strong> {{ number_format($data['balance'], 2) }}</span>
        <span><strong>Currency:</strong> {{ $data['currency'] }}</span>
        <span><strong>Email:</strong> {{ $data['email'] }}</span>
        <span><strong>Creation Date:</strong> {{ $data['date'] }}</span>
        <span><strong>Date Exported:</strong> {{ $data['data_exported'] }}</span>
    </div>
