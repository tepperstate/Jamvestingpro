  ...
  <div class="container-fluid">
   ...
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <div class="col-lg-6 mt-4 mx-auto">
         <p class='auth-title'><b>Note:</b> {{$user->first_name}} Demo account</span>
         <div class="border">
            <div class="p-0">
               <br>
               <div class="p-4 pb-6">
                  <form id="submit" class="user" method='post' action="{{route('fund_demo')}}">
                     <p>${{number_format($amount)}}</p>
                     <div class="form-group">
                        @csrf
                        <label style='font-size:14px;'>Debit amount</label>
