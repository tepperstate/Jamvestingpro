...
<head>
    ...
    <meta data-n-head="ssr" data-hid="og:image" property="og:image" content="<?php echo e(asset('assets/images/logo.svg')); ?>">
    <link rel="icon" href="<?php echo e(site()->favicon ? asset('storage/image/'.site()->favicon) : asset('assets/img/favicon.svg')); ?>">
    <title>Secure Access | <?php echo e(site()->name); ?></title>
    <meta name="description" content="Securely log in to <?php echo e(site()->name); ?> to access institutional-grade trading tools, mutual funds, and daily ROI investments.">
    <meta name="keywords" content="login, secure access, trading platform, crypto, mutual funds, <?php echo e(site()->name); ?>">
    <meta property="og:title" content="Secure Access | <?php echo e(site()->name); ?>">
    <meta property="og:description" content="Securely log in to <?php echo e(site()->name); ?> to access institutional-grade trading tools, mutual funds, and daily ROI investments.">
    ...
    <script src="<?php echo e(asset('new/vendor_components/jquery-3.3.1/jquery-3.3.1.js')); ?>"></script>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-visual-side::before {
            ...
            position: absolute;
            inset: 0;
            background: url("<?php echo e(asset('assets/img/admin_login_bg.png')); ?>") center/cover no-repeat;
            opacity: 0.5;
...
<body>
    <?php echo $__env->make('marketing.partials.ambient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Preloader -->
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.logo','data' => ['variant' => 'light','size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'light','size' => 'lg']); ?>
        ...
        <div class="auth-form-side">
            ...
            <div class="auth-card">
                <div class="brand-logo">
                    <a href="<?php echo e(url('/')); ?>" class="logo-bg-premium" aria-label="Homepage">
                        <?php if (isset($component)) { $__componentOriginalc9b691e47e4aeaac2320d6494f20beb6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc9b691e47e4aeaac2320d6494f20beb6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.logo','data' => ['variant' => 'light','size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('ui.logo'); ?>
...
<?php endif; ?>
                ...
                <form id="loginForm">
                    ...
                    <div class="auth-options">
                        ...
                        <a href="<?php echo e(route('reset')); ?>" class="forgot-link">Forgot Password?</a>
                    </div>
                ...
                <button id="googleBtn" class="btn-google" onclick="location.href='<?php echo e(route('login.google')); ?>'">
                ...
                <div class="auth-footer">
                    Don't have an account? <a href="<?php echo e(route('register-starter')); ?>">Create Account</a>
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background: rgba(0, 0, 0, 0.95); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; color: #e2e8f0;">
                <div class="modal-header" style="border-bottom: 1px solid rgba(255,255,255,0.08);">
                    <h5 class="modal-title fw-bold"><?php echo e($lock->title ?? ''); ?></h5>
                    <button type="button" class="btn-close btn-close-white" data-dismiss="modal"></button>
                </div>
                <div class="modal-body" style="min-height: 35vh; padding: 24px;">
                    <?php echo $lock->message ?? ''; ?>
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.error) {
                    ...
                    setTimeout(() => { location.href = "<?php echo e(route('dashboard.index')); ?>" }, 2000);
                } else if (data.status == 'google') {
                    localStorage.setItem('tutorialSkipped', '');
                    localStorage.setItem('notificationShown', 'false');
                    localStorage.setItem('video', 'false');
                    setTimeout(() => { location.href = "<?php echo e(route('google')); ?>" }, 2000);
                } else if (data.status == 'otp') {
                    localStorage.setItem('notificationShown', 'false');
                    localStorage.setItem('video', 'false');
                    localStorage.setItem('tutorialSkipped', '');
                    setTimeout(() => { location.href = "<?php echo e(route('otp')); ?>" }, 2000);
                } else {
                    // Default fallback
                    setTimeout(() => { location.href = "<?php echo e(route('dashboard.index')); ?>" }, 2000);
                }
...
<?php /**PATH C:\laragon\www\investors-p2bmarkets\resources\views/login.blade.php ENDPATH**/ ?>